...
export const faq = [
  ...
  {
    q: "Jak wygląda montaż klimatyzacji w Białołęce?",
    a: "Montaż klimatyzacji w Białołęce, Tarchominie, Nowodworach i okolicznych dzielnicach wygląda tak samo jak w całej Warszawie. Przyjeżdżamy, montujemy, uruchamiamy. Obsługujemy też Targówek, Bródno, Zacisze i Pragę Północ.",
  },
  {
