    ...
    <footer className="border-t border-white/10 bg-slate-950 text-white/70">
      <div className="mx-auto max-w-7xl px-5 py-12 lg:px-8">
        <div className="grid gap-10 md:grid-cols-3">
          ...
          <div>
            <h4 className="mb-4 flex items-center gap-2 text-sm font-bold uppercase tracking-widest text-white">
              <span>📍</span> Obszar działania
            </h4>
            <div className="space-y-1 text-sm text-white/80">
              <p>Białołęka, Targówek, Praga</p>
              <p>Marki, Ząbki, Zielonka, Wołomin</p>
              <p>Jabłonna, Łomianki, Legionowo</p>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="space-y-1 text-sm text-white/80">
              <p>Mitsubishi Electric • LG • Gree • Haier</p>
        ...
        <div className="mt-12 border-t border-white/10 pt-6 text-xs text-white/50">
          <div className="flex flex-col items-start justify-between gap-y-3 md:flex-row md:items-center">
            ...
            <p className="text-[10px] text-white/40">
              Usługi montażowe wykonuje firma posiadająca uprawnienia F-GAZ i SEP. Robogaz spółka z o.o.
            </p>
          </div>
        </div>
      </div>
